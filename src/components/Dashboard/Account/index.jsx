...
const Account = () => {
  ...
  const getUserProfile = async () => {
    try {
      const data = await axios.post(`${process.env.REACT_APP_API_URL}/api/users/profile`,{ userId: id }).then((response) => {
  ...
  const handleUpdateProfile = async (userData) => {
    ...
    try {
      const upDate = await axios.patch(`${process.env.REACT_APP_API_URL}/api/users/updateProfile`,{
        userId: id,
        name: name,
        address: address,
        phone: phone,
          ...
          <Card>
            ...
            >
              ...
              <Form.Item label="Home Address" name="address">
                <Input.TextArea placeholder="ex: House 45,Mirpur-1, Erode 638444" />
              </Form.Item>
